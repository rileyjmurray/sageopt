...
def sig_relaxation(f, X=None, form='dual', **kwargs):
    ...
    X : SigDomain
        Likely generated by ``sage_sigs.conditional_sage_data``.
...
def sig_dual(f, ell=0, X=None, modulator_support=None):
    ...
    X : SigDomain
        ...
        Otherwise, likely generated by ``sage_sigs.conditional_sage_data``.
...
def sage_feasibility(f, X=None, additional_cons=None):
    ...
    X : SigDomain
        If ``X`` is None, then this parameter is ignored.
        Otherwise, likely generated by ``sig_sage.conditional_sage_data``.
