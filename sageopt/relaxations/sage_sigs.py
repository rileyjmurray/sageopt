...
def conditional_sage_data(f, gts, eqs):
    ...
    :return: A dictionary X, keyed by three strings: 'AbK', 'gts', and 'eqs'.
    ...
    remaining columns are auxiliary variables needed to represent X in coniclifts
    primitives.
    ...
    Notes:
        ...
        This can be accomplished as follows:
            ...
            constraints = [cl.vector2norm(x) <= 1]
